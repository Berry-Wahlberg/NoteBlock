...
import LocalServerSignUpCallToAction from './JoplinCloudSignUpCallToAction';
import bridge from '../services/bridge';

const logger = Logger.create('LocalServerLoginScreen');
...
const LocalServerScreenComponent = (props: Props) => {
		...
		<div className="login-page">
			<div className="page-container">
				{state.active !== 'COMPLETED' ? (
					<>
						<p className="text">{_('To allow NoteBlock to synchronise with Local Server, please login using this URL:')}</p>
...
export default connect(mapStateToProps)(LocalServerScreenComponent);
